...
globalkeys = my_table.join(
    ...
    -- ctrl+alt +  ...
    awful.key({ modkey1, altkey   }, "w", function() awful.util.spawn( "archlinux-welcome-app" ) end,
        {description = "ArchLinux Welcome App", group = "alt+ctrl"}),
